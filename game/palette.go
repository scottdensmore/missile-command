...
var WavePalettes = [10]Palette{
	// Waves 1-2: 1X (Black Sky, Yellow Ground, Blue Cities)
	{
		...
		SiloColor:       color.RGBA{R: 228, G: 196, B: 36, A: 255},
	...
	// Waves 3-4: 2X (Black Sky, Blue Ground, Cyan Cities)
	{
		SkyColor:        color.RGBA{R: 0, G: 0, B: 0, A: 255},
		GroundColor:     color.RGBA{R: 36, G: 100, B: 240, A: 255},
		CityColor:       color.RGBA{R: 36, G: 224, B: 180, A: 255},
		SiloColor:       color.RGBA{R: 36, G: 100, B: 240, A: 255},
	...
	// Waves 5-6: 3X (Black Sky, Red Ground, Yellow Cities)
	{
		SkyColor:        color.RGBA{R: 0, G: 0, B: 0, A: 255},
	...
	// Waves 7-8: 4X (Black Sky, Red Ground, Cyan Cities)
	{
		SkyColor:        color.RGBA{R: 0, G: 0, B: 0, A: 255},
		GroundColor:     color.RGBA{R: 224, G: 36, B: 36, A: 255},
	...
	// Waves 9-10: 5X (Dark Blue Sky, Yellow Ground, Red Cities)
	{
	...
	// Waves 11-12: 6X (Light Blue Sky, Yellow Ground, Dark Blue Cities)
	{
	...
	// Waves 13-14: 6X (Purple Sky, Green Ground, Yellow Cities)
	{
		SkyColor:        color.RGBA{R: 140, G: 24, B: 140, A: 255},
		GroundColor:     color.RGBA{R: 36, G: 180, B: 48, A: 255},
		CityColor:       color.RGBA{R: 240, G: 220, B: 32, A: 255},
		SiloColor:       color.RGBA{R: 36, G: 180, B: 48, A: 255},
		ICBMColor:       color.RGBA{R: 240, G: 220, B: 32, A: 255},
		ABMColor:        color.RGBA{R: 36, G: 224, B: 224, A: 255},
		TextColor:       color.RGBA{R: 240, G: 220, B: 32, A: 255},
		MultiplierColor: color.RGBA{R: 240, G: 220, B: 32, A: 255},
	...
	// Waves 15-16: 6X (Yellow Sky, Green Ground, Red Cities)
	{
	...
	// Waves 17-18: 6X (White Sky, Red Ground, Blue Cities)
	{
	...
	// Waves 19-20: 6X (Red Sky, Yellow Ground, Black Cities)
	{
